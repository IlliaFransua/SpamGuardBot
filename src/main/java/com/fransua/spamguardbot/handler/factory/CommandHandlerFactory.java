...
public class CommandHandlerFactory {
  ...
  public static Handler createStartCommandHandler(
      TelegramClient telegramClient, BotConfigService configService) {
    Filter filterChain =
        Filter.builder()
            .add(new OnlyHumanSenderFilter())
            .add(
                new OnlyCommandFilter(
                    commandPrefix, BotConfig.Commands.START_COMMAND_WITHOUT_PREFIX))
  ...
  public static Handler createReportCommandHandler(
      TelegramClient telegramClient, BotConfigService configService) {
    Filter filterChain =
        Filter.builder()
            .add(new OnlyHumanSenderFilter())
            ...
            .add(
                new OnlyCommandFilter(
                    commandPrefix, BotConfig.Commands.REPORT_COMMAND_WITHOUT_PREFIX))
            .add(new OnlyChatIdFilter(configService.getChatId()))
            .build();
  ...
  public static Handler createSetLogChannelCommandHandler(
      TelegramClient telegramClient, BotConfigService configService) {
    Filter filterChain =
        Filter.builder()
            ...
            .add(
                new OnlyCommandFilter(
                    commandPrefix, BotConfig.Commands.Admin.SET_LOG_CHANNEL_COMMAND_WITHOUT_PREFIX))
            .build();
  ...
  public static Handler createSetChatCommandHandler(
      TelegramClient telegramClient, BotConfigService configService) {
    Filter filterChain =
        Filter.builder()
            .add(new OnlyAdminFilter(telegramClient))
            .add(
                new OnlyCommandFilter(
                    commandPrefix, BotConfig.Commands.Admin.SET_CHAT_COMMAND_WITHOUT_PREFIX))
            .build();
